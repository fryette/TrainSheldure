...
namespace Trains.Core.ViewModels
{
	public class BookingViewModel : MvxViewModel
	{
		...
		public BookingViewModel(IAppSettings appSettings, IHttpService httpService, IUserInteraction userInteraction, ISerializableService serializableService, IJsonConverter jsonConverter)
		{
